...
//to link with '-framework ApplicationServices'). #define IMGUI_DISABLE_FORMAT_STRING_FUNCTIONS             // Don't
//implement ImFormatString/ImFormatStringV so you can implement them yourself if you don't want to link with vsnprintf.
