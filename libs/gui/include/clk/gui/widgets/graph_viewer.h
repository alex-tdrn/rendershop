...
private:
	...
	std::unique_ptr<impl::widget_cache<clk::node const, impl::node_viewer>> node_cache;
	std::unique_ptr<impl::widget_cache<clk::port const, impl::port_viewer>> port_cache;
	mutable std::vector<std::pair<clk::input_port const*, clk::output_port const*>> connections;
